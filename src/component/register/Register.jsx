...
const Register = () => {
      ...
      const onSubmit = data => {
       ...
       //regex.....
          if(password.length<6){
            setRegisterError( 'al least 6 carccccter');
            Swal.fire({
                position: "top-end",
                icon: "error",
                title: "Oops...",
            ...
            return
             ...
             setRegisterError('your password should have any uppercase and Lowercase  character')
             Swal.fire({
                position: "top-end",
                icon: "error",
                title: "Oops...",
                text: "your password should have any uppercase and Lowercase  character",
                showConfirmButton: false,
                timer:2000
              });
    ...
    return (
        ...
        <form   onSubmit={handleSubmit(onSubmit)}  className="space-y-6">
            <div className="space-y-2 text-sm">
                ...
                <input  type="text" name="username" id="username" placeholder="Username" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " {...register("name",{required:true})} />
            ...
            <div className="space-y-2 text-sm">
                ...
                <input type="email" name="email" id="email "  placeholder="Email" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  "  {...register("email",{required:true})}/>
 ...
 <div className="space-y-2 text-sm">
                ...
                <input type="text" name="text" id="text "  placeholder="photo url" className="w-full px-4 py-3 rounded-md border border-indigo-300 focus:outline-none focus:ring  " {...register("photoUrl")} />
                {/* {errors.photoUrl && <span className='font-bold'>This field is required</span>} */}
            </div>
        ...
        <p className="text-sm text-center gap-2 flex justify-center sm:px-6 ">
            ...
            <Link to={'/login'} >  <span className='font-bold text-blue-950 text-[20px]'> login </span>  </Link>
        </p>
