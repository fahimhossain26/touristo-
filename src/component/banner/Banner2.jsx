...
const Banner2 = () => {
    ...
    <div className="flex w-full max-w-6xl gap-10 lg:flex-row flex-col items-center justify-between">
      <div className="max-w-md md:space-y-6 sm:space-y-5 space-y-4 " data-aos="fade-right">
        <h1 className="lg:text-5xl sm:text-4xl text-3xl font-bold leading-tight text-gray-900">Take your Tour to the next level.</h1>
        <p className="lg:text-lg sm:text-base text-sm text-gray-600">
          Track and improve the growth of your tours . Send the right place  your way with this destination 
        </p>
      ...
      <div className="relative " data-aos="zoom-in-up">  
        <img src="https://i.postimg.cc/HLdLhSkG/let-s-explore-world-tour-place-mdf-cut-out-round-shape-for-wall-original-imagcs2a5nadnygf.webp"  className="relative md:h-[600px]  sm:h-[500px] h-[300px]  w-[500px] rounded-b-full object-cover"/>
      </div>
    </div>
  </section>       
